...
/** @type {string} */
const CACHE_VERSION = '1724912509|2809054465';
/** @type {string} */
const CACHE_PREFIX = 'CsoundGodot-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'csoundgodot.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["csoundgodot.html","csoundgodot.js","csoundgodot.offline.html","csoundgodot.icon.png","csoundgodot.apple-touch-icon.png","csoundgodot.worker.js","csoundgodot.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["csoundgodot.wasm","csoundgodot.pck","csoundgodot.side.wasm","libcsoundgodot.web.template_debug.dev.wasm32.wasm"];
